...
static const color_point_f_t noise_gradient_map[] = {{0.0f, {0.043f, 0.0f, 1.0f}}, // #0b00ff
                                                     {0.155f, {0.043f, 0.0f, 1.0f}},
                                                     {0.607f, {1.0f, 0.0f, 0.95f}},  // #ff00f1
                                                     {0.782f, {1.0f, 0.270f, 0.0f}}, // #ff4500
                                                     {1.0f, {1.0f, 0.270f, 0.0f}}};

static const uint8_t noise_gradient_map_size = sizeof(noise_gradient_map) / sizeof(noise_gradient_map[0]);
...
static inline float_rgb_t interpolate_gradient_f(float val) {
    ...
    if (val >= noise_gradient_map[noise_gradient_map_size - 1].position) return noise_gradient_map[noise_gradient_map_size - 1].color;
